...
Additional configurations to be tested later:
...
- Write pointer does not advance when full
...
- Read pointer does not advance when empty
...
### Test 9: Full/Empty Flag Transition
